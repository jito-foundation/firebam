...
| <span class="metrics-name">bam_&#8203;bundle_&#8203;received</span> | counter | Cumulative number of revert-on-error AtomicTxnBatch entries accepted and published to verify as BAM bundles |
...
| <span class="metrics-name">bam_&#8203;packets_&#8203;dropped</span> | counter | Cumulative number of BAM AtomicTxnBatch packets rejected during decode because their declared payload exceeded the local MTU |
...
| <span class="metrics-name">bam_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">result_&#8203;sent</span>"} | counter | Cumulative number of BAM outbound message send attempts by message kind and outcome (Result message sent successfully) |
| <span class="metrics-name">bam_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">result_&#8203;no_&#8203;stream</span>"} | counter | Cumulative number of BAM outbound message send attempts by message kind and outcome (Result send skipped because stream is unavailable (not established or not live)) |
| <span class="metrics-name">bam_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">result_&#8203;send_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound message send attempts by message kind and outcome (Result send attempted but failed in gRPC stream_send) |
| <span class="metrics-name">bam_&#8203;client_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">request_&#8203;blocked</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because gRPC request path is blocked) |
| <span class="metrics-name">bam_&#8203;client_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">stall_&#8203;backoff</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because reconnect backoff is active) |
| <span class="metrics-name">bam_&#8203;client_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">not_&#8203;connected</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped while waiting for TCP connect progression) |
| <span class="metrics-name">bam_&#8203;client_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">drive_&#8203;io_&#8203;fail</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because drive_io failed or a deferred reset was pending) |
| <span class="metrics-name">bam_&#8203;stream_&#8203;state_&#8203;transition</span><br/>{bam_&#8203;stream_&#8203;transition="<span class="metrics-enum">down_&#8203;to_&#8203;live</span>"} | counter | Cumulative number of scheduler stream live-state transitions (Scheduler stream transitioned from not-live to live) |
| <span class="metrics-name">bam_&#8203;stream_&#8203;state_&#8203;transition</span><br/>{bam_&#8203;stream_&#8203;transition="<span class="metrics-enum">live_&#8203;to_&#8203;down</span>"} | counter | Cumulative number of scheduler stream live-state transitions (Scheduler stream transitioned from live to not-live) |
