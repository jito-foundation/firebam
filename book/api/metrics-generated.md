...
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">received</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work reached pack after ingress preprocessing and resolution) |
...
| <span class="metrics-name">gossvf_&#8203;crds_&#8203;rx</span><br/>{gossvf_&#8203;crds_&#8203;outcome="<span class="metrics-enum">success_&#8203;pull_&#8203;response_&#8203;duplicate</span>"} | counter | CRDS values processed (Pull Response (duplicate)) |
...
| <span class="metrics-name">gossvf_&#8203;crds_&#8203;rx</span><br/>{gossvf_&#8203;crds_&#8203;outcome="<span class="metrics-enum">success_&#8203;push_&#8203;duplicate</span>"} | counter | CRDS values processed (Push (duplicate)) |
...
| <span class="metrics-name">gossvf_&#8203;crds_&#8203;rx_&#8203;bytes</span><br/>{gossvf_&#8203;crds_&#8203;outcome="<span class="metrics-enum">success_&#8203;pull_&#8203;response_&#8203;duplicate</span>"} | counter | Wire bytes of CRDS values processed (Pull Response (duplicate)) |
...
| <span class="metrics-name">gossvf_&#8203;crds_&#8203;rx_&#8203;bytes</span><br/>{gossvf_&#8203;crds_&#8203;outcome="<span class="metrics-enum">success_&#8203;push_&#8203;duplicate</span>"} | counter | Wire bytes of CRDS values processed (Push (duplicate)) |
...
| <span class="metrics-name">bam_&#8203;healthy</span> | gauge | Boolean gauge: 1 when the BAM client transport, auth, config, scheduler stream, and BuilderHeartBeat recency checks are healthy; otherwise 0. This does not imply that fresh work for the current leader slot has arrived yet. |
...
| <span class="metrics-name">bam_&#8203;ingress_&#8203;packet_&#8203;oversize</span> | counter | Cumulative number of BAM packets rejected because their protobuf data payload exceeded the local transaction MTU |
...
| <span class="metrics-name">bam_&#8203;ssl_&#8203;alloc_&#8203;failed</span> | counter | Cumulative number of OpenSSL allocation failures in the BAM tile heap. Any nonzero value means the SSL heap (development.bam.ssl_heap_size_mib) is too small. |
