...
| <span class="metrics-name">pack_&#8203;bam_&#8203;bundle_&#8203;abandon</span><br/>{pack_&#8203;bam_&#8203;bundle_&#8203;abandon_&#8203;reason="<span class="metrics-enum">new_&#8203;seq_&#8203;before_&#8203;complete</span>"} | counter | Cumulative number of active BAM bundles abandoned due to sequencing or leader-slot boundary conditions, by reason (does not include blockhash-expiry invalidation after full reception) (Active BAM bundle abandoned because a new sequence arrived before completion) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;bundle_&#8203;abandon</span><br/>{pack_&#8203;bam_&#8203;bundle_&#8203;abandon_&#8203;reason="<span class="metrics-enum">leader_&#8203;slot_&#8203;end</span>"} | counter | Cumulative number of active BAM bundles abandoned due to sequencing or leader-slot boundary conditions, by reason (does not include blockhash-expiry invalidation after full reception) (Active BAM bundle abandoned at leader slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;bundle_&#8203;abandon</span><br/>{pack_&#8203;bam_&#8203;bundle_&#8203;abandon_&#8203;reason="<span class="metrics-enum">outside_&#8203;leader_&#8203;slot</span>"} | counter | Cumulative number of active BAM bundles abandoned due to sequencing or leader-slot boundary conditions, by reason (does not include blockhash-expiry invalidation after full reception) (BAM bundle abandoned because packing moved outside the leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;bundle_&#8203;abandon</span><br/>{pack_&#8203;bam_&#8203;bundle_&#8203;abandon_&#8203;reason="<span class="metrics-enum">poh_&#8203;timeout</span>"} | counter | Cumulative number of active BAM bundles abandoned due to sequencing or leader-slot boundary conditions, by reason (does not include blockhash-expiry invalidation after full reception) (Active BAM bundle abandoned because the PoH leader-slot wallclock deadline elapsed) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;single_&#8203;txn_&#8203;invalid</span><br/>{pack_&#8203;bam_&#8203;single_&#8203;txn_&#8203;invalid_&#8203;reason="<span class="metrics-enum">outside_&#8203;slot</span>"} | counter | Cumulative number of independent BAM transactions rejected after slot/blockhash revalidation, including extra-storage reinsertion and pending-work eviction, by reason (Independent BAM transaction rejected because packing moved outside its allowed slot window) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;single_&#8203;txn_&#8203;invalid</span><br/>{pack_&#8203;bam_&#8203;single_&#8203;txn_&#8203;invalid_&#8203;reason="<span class="metrics-enum">blockhash_&#8203;expired</span>"} | counter | Cumulative number of independent BAM transactions rejected after slot/blockhash revalidation, including extra-storage reinsertion and pending-work eviction, by reason (Independent BAM transaction rejected because its blockhash expired) |
...
| <span class="metrics-name">bam_&#8203;validator_&#8203;heartbeats_&#8203;sent</span> | counter | Cumulative number of validator heartbeat messages successfully sent to the BAM node |
| <span class="metrics-name">bam_&#8203;builder_&#8203;heartbeats_&#8203;received</span> | counter | Cumulative number of builder heartbeat messages successfully decoded from the BAM node |
...
| <span class="metrics-name">bam_&#8203;connections</span> | counter | Cumulative number of transitions into BAM CONNECTED_HEALTHY state |
| <span class="metrics-name">bam_&#8203;disconnects</span> | counter | Cumulative number of transitions out of BAM CONNECTED_HEALTHY state |
...
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;send_&#8203;outcome="<span class="metrics-enum">leader_&#8203;state_&#8203;sent</span>"} | counter | Cumulative number of BAM outbound leader-state/result send outcomes by message kind and outcome (Leader-state message sent successfully) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;send_&#8203;outcome="<span class="metrics-enum">leader_&#8203;state_&#8203;no_&#8203;stream</span>"} | counter | Cumulative number of BAM outbound leader-state/result send outcomes by message kind and outcome (Leader-state send skipped because stream is unavailable (not established or not live)) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;send_&#8203;outcome="<span class="metrics-enum">leader_&#8203;state_&#8203;send_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound leader-state/result send outcomes by message kind and outcome (Leader-state send attempted but failed in gRPC stream_send) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;send_&#8203;outcome="<span class="metrics-enum">result_&#8203;sent</span>"} | counter | Cumulative number of BAM outbound leader-state/result send outcomes by message kind and outcome (Result message sent successfully) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;send_&#8203;outcome="<span class="metrics-enum">result_&#8203;send_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound leader-state/result send outcomes by message kind and outcome (Result send attempted but failed in gRPC stream_send) |
...
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;ping_&#8203;response_&#8203;nanos</span> | histogram | Distribution of BAM scheduler Ping response latencies from scheduler-message receive callback to successful Pong send completion (nanoseconds) |
