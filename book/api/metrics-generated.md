...
| <span class="metrics-name">bam_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">drive_&#8203;io_&#8203;fail</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because drive_io failed or a deferred reset was pending) |
...
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">client_&#8203;reset</span>"} | counter | Cumulative number of pending leader-state updates dropped before send, by reason (Pending leader-state cleared because BAM client was reset) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">request_&#8203;failed</span>"} | counter | Cumulative number of pending leader-state updates dropped before send, by reason (Pending leader-state cleared because scheduler stream request failed) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">stream_&#8203;ended</span>"} | counter | Cumulative number of pending leader-state updates dropped before send, by reason (Pending leader-state cleared because scheduler stream ended) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">stream_&#8203;timeout</span>"} | counter | Cumulative number of pending leader-state updates dropped before send, by reason (Pending leader-state cleared because scheduler stream timed out) |
