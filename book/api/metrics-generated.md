...
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">no_&#8203;event</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, or a first BAM insert after slot end (No BAM event of this kind was observed before the leader slot finished) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">before_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, or a first BAM insert after slot end (The first BAM event of this kind was observed at or before slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">after_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, or a first BAM insert after slot end (The first BAM event of this kind was observed after slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">no_&#8203;event</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, or a first BAM schedule after slot end (No BAM event of this kind was observed before the leader slot finished) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">before_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, or a first BAM schedule after slot end (The first BAM event of this kind was observed at or before slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">after_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, or a first BAM schedule after slot end (The first BAM event of this kind was observed after slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;distance_&#8203;nanos</span> | histogram | Absolute distance in nanoseconds between slot_end_ns and the first BAM insert observed for a finalized pack leader slot. Sampled once per slot only when an insert was observed. |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;distance_&#8203;nanos</span> | histogram | Absolute distance in nanoseconds between slot_end_ns and the first BAM schedule observed for a finalized pack leader slot. Sampled once per slot only when a schedule was observed. |
...
| <span class="metrics-name">pack_&#8203;bam_&#8203;seq_&#8203;rx_&#8203;to_&#8203;first_&#8203;schedule_&#8203;nanos</span> | histogram | Distribution of BAM scheduler-arrival to first-schedule delay for a sequence id, sampled once on the first schedule event for that sequence (nanoseconds) |
...
| <span class="metrics-name">bam_&#8203;healthy</span> | gauge | Boolean gauge: 1 when the BAM client transport, auth, config, scheduler stream, and heartbeat checks are healthy; otherwise 0. This does not imply that fresh work for the current leader slot has arrived yet. |
...
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">builder_&#8203;heartbeat_&#8203;timeout</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Builder heartbeat watchdog timed out while the scheduler stream was live) |
...
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">no_&#8203;ingress</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by first ingress relative to slot end (No BAM ingress was observed for the slot before its debug retention window expired) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">first_&#8203;before_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by first ingress relative to slot end (The first BAM ingress observed for the slot arrived before slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">first_&#8203;after_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by first ingress relative to slot end (The first BAM ingress observed for the slot arrived after slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">unknown_&#8203;slot_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by first ingress relative to slot end (BAM ingress was observed for the slot but slot_end_ns was unavailable when the slot aged out of the retention window) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">before_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized per-slot ingress rollups, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown (BAM ingress transactions observed before slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">after_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized per-slot ingress rollups, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown (BAM ingress transactions observed after slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">unknown_&#8203;slot_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized per-slot ingress rollups, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown (BAM ingress transactions observed while slot_end_ns was unavailable) |
...
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;recorded</span> | gauge | Boolean gauge: 1 when BAM has observed at least one ingress transaction for the current leader slot, 0 otherwise |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;slot_&#8203;end_&#8203;known</span> | gauge | Boolean gauge: 1 when slot_end_ns is known for the current leader slot's first observed BAM ingress, 0 otherwise |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;distance_&#8203;nanos</span> | gauge | Absolute distance in nanoseconds between the current leader slot's slot_end_ns and its first observed BAM ingress. Exported as 0 until a first ingress has been observed and slot_end_ns is known |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;after_&#8203;end</span> | gauge | Boolean gauge: 1 when the current leader slot's first observed BAM ingress arrived after slot end, 0 when it arrived before slot end or the relation is not yet known |
