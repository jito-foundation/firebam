...
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">protocol</span>"} | counter | Cumulative number of BAM client failures by class (Unsupported BAM protocol version or message shape from the peer) |
...
| <span class="metrics-name">bam_&#8203;ingress_&#8203;multi_&#8203;message_&#8203;empty</span> | counter | Cumulative number of multiple_atomic_txn_batch messages that contained zero AtomicTxnBatch entries |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;multi_&#8203;message_&#8203;overflow</span> | counter | Cumulative number of multiple_atomic_txn_batch messages that exceeded the local max batch count |
...
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">invalid_&#8203;batch</span>"} | counter | Cumulative number of BAM AtomicTxnBatch rejects by reason (Batch rejected because packet decode or batch structure was invalid) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">empty_&#8203;batch</span>"} | counter | Cumulative number of BAM AtomicTxnBatch rejects by reason (Batch rejected because it contained zero packets) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">vote_&#8203;transaction</span>"} | counter | Cumulative number of BAM AtomicTxnBatch rejects by reason (Batch rejected because it contained a simple vote transaction) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">non_&#8203;revert_&#8203;multi_&#8203;packet</span>"} | counter | Cumulative number of BAM AtomicTxnBatch rejects by reason (Batch rejected because a non-revert batch contained multiple packets) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">empty_&#8203;message</span>"} | counter | Cumulative number of BAM AtomicTxnBatch rejects by reason (Reject staged because a multiple_atomic_txn_batch message contained zero batches) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">overflow_&#8203;message</span>"} | counter | Cumulative number of BAM AtomicTxnBatch rejects by reason (Reject staged because a multiple_atomic_txn_batch message exceeded the local max batch count) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">leader_&#8203;state_&#8203;sent</span>"} | counter | Cumulative number of BAM outbound leader-state/result send attempts by message kind and outcome (Leader-state message sent successfully) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">leader_&#8203;state_&#8203;no_&#8203;stream</span>"} | counter | Cumulative number of BAM outbound leader-state/result send attempts by message kind and outcome (Leader-state send skipped because stream is unavailable (not established or not live)) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">leader_&#8203;state_&#8203;send_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound leader-state/result send attempts by message kind and outcome (Leader-state send attempted but failed in gRPC stream_send) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">result_&#8203;sent</span>"} | counter | Cumulative number of BAM outbound leader-state/result send attempts by message kind and outcome (Result message sent successfully) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">result_&#8203;no_&#8203;stream</span>"} | counter | Cumulative number of BAM outbound leader-state/result send attempts by message kind and outcome (Result send skipped because stream is unavailable (not established or not live)) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;send_&#8203;attempt</span><br/>{bam_&#8203;send_&#8203;attempt="<span class="metrics-enum">result_&#8203;send_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound leader-state/result send attempts by message kind and outcome (Result send attempted but failed in gRPC stream_send) |
...
| <span class="metrics-name">bam_&#8203;rtt_&#8203;deviation</span> | gauge | Smoothed RTT variation estimate (nanoseconds) |
