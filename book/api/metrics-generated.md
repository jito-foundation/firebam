...
| <span class="metrics-name">bundle_&#8203;conn_&#8203;error</span><br/>{bundle_&#8203;error="<span class="metrics-enum">no_&#8203;fee_&#8203;info</span>"} | counter | gRPC errors encountered (Bundle dropped due to missing builder info) |
