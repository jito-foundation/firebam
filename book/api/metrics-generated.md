...
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;rejected_&#8203;pre_&#8203;pending</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;invalid_&#8203;reason="<span class="metrics-enum">single_&#8203;outside_&#8203;slot</span>"} | counter | Cumulative number of BAM transactions or fully assembled BAM bundles rejected by slot/blockhash revalidation before they were accepted into pack's pending-work tracker, by work kind and reason (Independent BAM transaction invalidated because packing moved outside its allowed slot window) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;rejected_&#8203;pre_&#8203;pending</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;invalid_&#8203;reason="<span class="metrics-enum">single_&#8203;blockhash_&#8203;expired</span>"} | counter | Cumulative number of BAM transactions or fully assembled BAM bundles rejected by slot/blockhash revalidation before they were accepted into pack's pending-work tracker, by work kind and reason (Independent BAM transaction invalidated because its blockhash expired) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;rejected_&#8203;pre_&#8203;pending</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;invalid_&#8203;reason="<span class="metrics-enum">bundle_&#8203;outside_&#8203;slot</span>"} | counter | Cumulative number of BAM transactions or fully assembled BAM bundles rejected by slot/blockhash revalidation before they were accepted into pack's pending-work tracker, by work kind and reason (Fully assembled BAM bundle invalidated because packing moved outside its allowed slot window) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;rejected_&#8203;pre_&#8203;pending</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;invalid_&#8203;reason="<span class="metrics-enum">bundle_&#8203;blockhash_&#8203;expired</span>"} | counter | Cumulative number of BAM transactions or fully assembled BAM bundles rejected by slot/blockhash revalidation before they were accepted into pack's pending-work tracker, by work kind and reason (Fully assembled BAM bundle invalidated because one of its blockhashes expired) |
...
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">received</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work was received from the scheduler stream or BAM ingress fanout) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">accepted</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work was accepted into pack's main transaction pool) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">rejected_&#8203;pre_&#8203;pending</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work was rejected before entering pack's pending-work tracker) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">pending_&#8203;entered</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work entered pack's pending-work tracker after acceptance) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">pending_&#8203;evicted</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work was evicted from pack's pending-work tracker by later slot or blockhash revalidation) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">scheduled</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work was removed from the pending-work tracker and scheduled into a microblock) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">landed</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work was observed as landed via execution feedback) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">received</span>"} | counter | Cumulative number of BAM transactions observed at each pack lifecycle stage. (BAM work was received from the scheduler stream or BAM ingress fanout) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">accepted</span>"} | counter | Cumulative number of BAM transactions observed at each pack lifecycle stage. (BAM work was accepted into pack's main transaction pool) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">rejected_&#8203;pre_&#8203;pending</span>"} | counter | Cumulative number of BAM transactions observed at each pack lifecycle stage. (BAM work was rejected before entering pack's pending-work tracker) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">pending_&#8203;entered</span>"} | counter | Cumulative number of BAM transactions observed at each pack lifecycle stage. (BAM work entered pack's pending-work tracker after acceptance) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">pending_&#8203;evicted</span>"} | counter | Cumulative number of BAM transactions observed at each pack lifecycle stage. (BAM work was evicted from pack's pending-work tracker by later slot or blockhash revalidation) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">scheduled</span>"} | counter | Cumulative number of BAM transactions observed at each pack lifecycle stage. (BAM work was removed from the pending-work tracker and scheduled into a microblock) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">landed</span>"} | counter | Cumulative number of BAM transactions observed at each pack lifecycle stage. (BAM work was observed as landed via execution feedback) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;tracking_&#8203;rejected</span> | counter | Cumulative number of BAM work items rejected because the local tracked-work table was at capacity |
| <span class="metrics-name">pack_&#8203;bam_&#8203;tracking_&#8203;rejected_&#8203;transactions</span> | counter | Cumulative number of BAM transactions rejected because the local tracked-work table was at capacity |
...
| <span class="metrics-name">pack_&#8203;leader_&#8203;slot</span> | gauge | Current pack leader slot, or 0 if pack is not the leader |
| <span class="metrics-name">pack_&#8203;leader_&#8203;slot_&#8203;end_&#8203;nanos</span> | gauge | Current pack leader slot end wallclock timestamp (nanoseconds), or 0 if pack is not the leader |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">no_&#8203;event</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, exactly at slot end, or after slot end (No BAM event of this kind was observed before the leader slot finished) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">before_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, exactly at slot end, or after slot end (The first BAM event of this kind was observed before slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">at_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, exactly at slot end, or after slot end (The first BAM event of this kind was observed exactly at slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">after_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, exactly at slot end, or after slot end (The first BAM event of this kind was observed after slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">no_&#8203;event</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, exactly at slot end, or after slot end (No BAM event of this kind was observed before the leader slot finished) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">before_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, exactly at slot end, or after slot end (The first BAM event of this kind was observed before slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">at_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, exactly at slot end, or after slot end (The first BAM event of this kind was observed exactly at slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;result</span><br/>{pack_&#8203;bam_&#8203;first_&#8203;event_&#8203;result="<span class="metrics-enum">after_&#8203;end</span>"} | counter | Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, exactly at slot end, or after slot end (The first BAM event of this kind was observed after slot end) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;before_&#8203;end_&#8203;distance_&#8203;nanos</span> | histogram | Distance in nanoseconds from the first BAM insert to slot_end_ns for a finalized pack leader slot when that first insert was observed before slot end. Sampled once per slot only for before-end inserts. |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;after_&#8203;end_&#8203;distance_&#8203;nanos</span> | histogram | Distance in nanoseconds from slot_end_ns to the first BAM insert for a finalized pack leader slot when that first insert was observed after slot end. Sampled once per slot only for after-end inserts. |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;before_&#8203;end_&#8203;distance_&#8203;nanos</span> | histogram | Distance in nanoseconds from the first BAM schedule to slot_end_ns for a finalized pack leader slot when that first schedule was observed before slot end. Sampled once per slot only for before-end schedules. |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;after_&#8203;end_&#8203;distance_&#8203;nanos</span> | histogram | Distance in nanoseconds from slot_end_ns to the first BAM schedule for a finalized pack leader slot when that first schedule was observed after slot end. Sampled once per slot only for after-end schedules. |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">received</span>"} | gauge | Per-current-pack-leader-slot BAM work-item counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work received for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">accepted</span>"} | gauge | Per-current-pack-leader-slot BAM work-item counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work accepted into pack for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">rejected_&#8203;pre_&#8203;pending</span>"} | gauge | Per-current-pack-leader-slot BAM work-item counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work rejected before pending tracking for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">pending</span>"} | gauge | Per-current-pack-leader-slot BAM work-item counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work currently pending in pack for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">evicted_&#8203;post_&#8203;pending</span>"} | gauge | Per-current-pack-leader-slot BAM work-item counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work evicted after pending acceptance for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">scheduled</span>"} | gauge | Per-current-pack-leader-slot BAM work-item counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work scheduled for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">landed</span>"} | gauge | Per-current-pack-leader-slot BAM work-item counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work observed as landed for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">received</span>"} | gauge | Per-current-pack-leader-slot BAM transaction counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work received for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">accepted</span>"} | gauge | Per-current-pack-leader-slot BAM transaction counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work accepted into pack for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">rejected_&#8203;pre_&#8203;pending</span>"} | gauge | Per-current-pack-leader-slot BAM transaction counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work rejected before pending tracking for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">pending</span>"} | gauge | Per-current-pack-leader-slot BAM transaction counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work currently pending in pack for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">evicted_&#8203;post_&#8203;pending</span>"} | gauge | Per-current-pack-leader-slot BAM transaction counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work evicted after pending acceptance for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">scheduled</span>"} | gauge | Per-current-pack-leader-slot BAM transaction counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work scheduled for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;state="<span class="metrics-enum">landed</span>"} | gauge | Per-current-pack-leader-slot BAM transaction counts from pack's recent-slot tracker. Exported as 0 when pack is not leader or no BAM work has been recorded for the current leader slot. (BAM work observed as landed for the current pack leader slot) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">received</span>"} | gauge | BAM work-item counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending work; the other states accumulate work that remained unresolved when it passed through each stage. (BAM work received with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">accepted</span>"} | gauge | BAM work-item counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending work; the other states accumulate work that remained unresolved when it passed through each stage. (BAM work accepted into pack with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">rejected_&#8203;pre_&#8203;pending</span>"} | gauge | BAM work-item counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending work; the other states accumulate work that remained unresolved when it passed through each stage. (BAM work rejected before pending tracking with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">pending</span>"} | gauge | BAM work-item counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending work; the other states accumulate work that remained unresolved when it passed through each stage. (BAM work currently pending in pack with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">evicted_&#8203;post_&#8203;pending</span>"} | gauge | BAM work-item counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending work; the other states accumulate work that remained unresolved when it passed through each stage. (BAM work evicted after pending acceptance with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">scheduled</span>"} | gauge | BAM work-item counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending work; the other states accumulate work that remained unresolved when it passed through each stage. (BAM work scheduled with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">landed</span>"} | gauge | BAM work-item counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending work; the other states accumulate work that remained unresolved when it passed through each stage. (BAM work observed as landed with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">received</span>"} | gauge | BAM transaction counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending transactions; the other states accumulate transactions that remained unresolved when they passed through each stage. (BAM work received with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">accepted</span>"} | gauge | BAM transaction counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending transactions; the other states accumulate transactions that remained unresolved when they passed through each stage. (BAM work accepted into pack with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">rejected_&#8203;pre_&#8203;pending</span>"} | gauge | BAM transaction counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending transactions; the other states accumulate transactions that remained unresolved when they passed through each stage. (BAM work rejected before pending tracking with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">pending</span>"} | gauge | BAM transaction counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending transactions; the other states accumulate transactions that remained unresolved when they passed through each stage. (BAM work currently pending in pack with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">evicted_&#8203;post_&#8203;pending</span>"} | gauge | BAM transaction counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending transactions; the other states accumulate transactions that remained unresolved when they passed through each stage. (BAM work evicted after pending acceptance with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">scheduled</span>"} | gauge | BAM transaction counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending transactions; the other states accumulate transactions that remained unresolved when they passed through each stage. (BAM work scheduled with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;unresolved_&#8203;work_&#8203;transactions</span><br/>{pack_&#8203;bam_&#8203;unresolved_&#8203;state="<span class="metrics-enum">landed</span>"} | gauge | BAM transaction counts in pack's explicit unresolved-slot bucket. Pending is current unresolved pending transactions; the other states accumulate transactions that remained unresolved when they passed through each stage. (BAM work observed as landed with unresolved slot attribution) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome="<span class="metrics-enum">rejected_&#8203;pre_&#8203;pending</span>"} | counter | Cumulative number of BAM work items bucketed by their first terminal pack outcome (BAM work was first rejected before entering pack's pending-work tracker) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome="<span class="metrics-enum">tracking_&#8203;rejected</span>"} | counter | Cumulative number of BAM work items bucketed by their first terminal pack outcome (BAM work was accepted into pack but rejected because the tracked-work table was full) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome="<span class="metrics-enum">pending_&#8203;evicted</span>"} | counter | Cumulative number of BAM work items bucketed by their first terminal pack outcome (BAM work entered pack's pending-work tracker and was later evicted by slot or blockhash revalidation) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome="<span class="metrics-enum">scheduled</span>"} | counter | Cumulative number of BAM work items bucketed by their first terminal pack outcome (BAM work entered pack's pending-work tracker and was later first scheduled into a microblock) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;first_&#8203;outcome="<span class="metrics-enum">bundle_&#8203;assembly_&#8203;abandoned</span>"} | counter | Cumulative number of BAM work items bucketed by their first terminal pack outcome (Multi-transaction BAM work was abandoned before full assembly completed) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;rx_&#8203;to_&#8203;first_&#8203;outcome_&#8203;nanos</span> | histogram | Distribution of BAM scheduler-receive to first terminal pack outcome for a BAM work item, sampled once when that work is first rejected, tracking-rejected, pending-evicted, scheduled, or bundle-assembly-abandoned (nanoseconds) |
...
| <span class="metrics-name">replay_&#8203;slot_&#8203;duration_&#8203;nanos</span> | gauge | Replay's current slot-duration assumption in nanoseconds |
...
| <span class="metrics-name">bam_&#8203;healthy</span> | gauge | Boolean gauge: 1 when the BAM client transport, auth, config, scheduler stream, and builder-activity checks are healthy; otherwise 0. This does not imply that fresh work for the current leader slot has arrived yet. |
| <span class="metrics-name">bam_&#8203;stream_&#8203;live</span> | gauge | Boolean gauge: 1 when the BAM scheduler gRPC stream is established and live, 0 otherwise |
| <span class="metrics-name">bam_&#8203;leader_&#8203;state_&#8203;slot</span> | gauge | Latest validator leader slot carried in pack->bam leader-state snapshots, or 0 if none has been observed yet |
| <span class="metrics-name">bam_&#8203;leader_&#8203;state_&#8203;tick</span> | gauge | Latest validator leader tick carried in pack->bam leader-state snapshots |
| <span class="metrics-name">bam_&#8203;leader_&#8203;state_&#8203;slot_&#8203;end_&#8203;nanos</span> | gauge | Latest validator leader slot_end_ns carried in pack->bam leader-state snapshots (nanoseconds), or 0 if unknown |
...
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">auth_&#8203;challenge_&#8203;decode</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Local protobuf or validation failure while decoding bam_api.AuthChallengeResponse) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">config_&#8203;decode</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Local protobuf decode failure while decoding bam_api.ConfigResponse) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">scheduler_&#8203;envelope_&#8203;decode</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Local protobuf or scheduler-envelope decode failure while decoding bam_api.SchedulerResponse) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">request_&#8203;failed</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (HTTP or gRPC request completed with a non-OK status) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">resolve</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (DNS resolution failure while resolving the BAM endpoint) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">connect</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (TCP connect failure while establishing the BAM transport) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">io</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (TLS, HTTP/2, or stream I/O failure on an established BAM connection) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">unsupported_&#8203;version</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Unsupported scheduler-response version received from the BAM peer) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">request_&#8203;timeout</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Auth, config, or scheduler-stream gRPC request timed out) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">keepalive_&#8203;timeout</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (HTTP/2 keepalive PING timed out) |
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">builder_&#8203;activity_&#8203;timeout</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Scheduler-stream builder activity watchdog timed out while the scheduler stream was live) |
| <span class="metrics-name">bam_&#8203;heap_&#8203;size</span> | gauge | Total workspace capacity reserved for the BAM tile (bytes). Sampled at most once per second to avoid repeated workspace scans. |
| <span class="metrics-name">bam_&#8203;heap_&#8203;free_&#8203;bytes</span> | gauge | Estimated free capacity in the BAM tile workspace heap (bytes). Sampled at most once per second to avoid repeated workspace scans. |
...
| <span class="metrics-name">bam_&#8203;grpc_&#8203;wakeups</span> | counter | Cumulative number of times the BAM gRPC client was polled for I/O |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;stream_&#8203;errors</span> | counter | Cumulative number of survivable BAM gRPC stream errors, including out-of-memory and decode failures |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;connection_&#8203;errors</span> | counter | Cumulative number of BAM gRPC connection errors that terminated the connection |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;stream_&#8203;chunks_&#8203;tx</span> | counter | Cumulative number of BAM gRPC DATA frames carrying outbound request bytes |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;stream_&#8203;chunks_&#8203;tx_&#8203;bytes</span> | counter | Cumulative number of outbound BAM gRPC request payload bytes carried in DATA frames |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;stream_&#8203;chunks_&#8203;rx</span> | counter | Cumulative number of BAM gRPC DATA frames carrying inbound response bytes |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;stream_&#8203;chunks_&#8203;rx_&#8203;bytes</span> | counter | Cumulative number of inbound BAM gRPC response payload bytes carried in DATA frames |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;requests_&#8203;sent</span> | counter | Cumulative number of BAM gRPC requests whose request body finished sending |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;streams_&#8203;active</span> | gauge | Current number of BAM gRPC streams that are not closed |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;rx_&#8203;wait_&#8203;nanos</span> | counter | Cumulative BAM gRPC inbound wait time while HTTP/2 frames and messages were partially received (nanoseconds) |
| <span class="metrics-name">bam_&#8203;grpc_&#8203;tx_&#8203;wait_&#8203;nanos</span> | counter | Cumulative BAM gRPC outbound wait time while requests were queued or flow-controlled before handoff to TCP (nanoseconds) |
...
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">invalid_&#8203;batch</span>"} | counter | Cumulative number of AtomicTxnBatch entry rejects by reason after decode and batch-level validation. Wrapper-level message rejects are counted separately in bam_ingress_message_rejected. (Batch rejected because AtomicTxnBatch decode or structural validation failed) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">empty_&#8203;batch</span>"} | counter | Cumulative number of AtomicTxnBatch entry rejects by reason after decode and batch-level validation. Wrapper-level message rejects are counted separately in bam_ingress_message_rejected. (Batch rejected because it contained zero packets) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">vote_&#8203;transaction</span>"} | counter | Cumulative number of AtomicTxnBatch entry rejects by reason after decode and batch-level validation. Wrapper-level message rejects are counted separately in bam_ingress_message_rejected. (Batch rejected because it contained a simple vote transaction) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">non_&#8203;revert_&#8203;multi_&#8203;packet</span>"} | counter | Cumulative number of AtomicTxnBatch entry rejects by reason after decode and batch-level validation. Wrapper-level message rejects are counted separately in bam_ingress_message_rejected. (Batch rejected because a non-revert batch contained multiple packets) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;message_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;message_&#8203;reject_&#8203;reason="<span class="metrics-enum">empty_&#8203;message</span>"} | counter | Cumulative number of multiple_atomic_txn_batch wrapper rejects by reason. These count scheduler messages, not AtomicTxnBatch entries. (multiple_atomic_txn_batch wrapper rejected because it contained zero AtomicTxnBatch entries) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;message_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;message_&#8203;reject_&#8203;reason="<span class="metrics-enum">overflow_&#8203;message</span>"} | counter | Cumulative number of multiple_atomic_txn_batch wrapper rejects by reason. These count scheduler messages, not AtomicTxnBatch entries. (multiple_atomic_txn_batch wrapper rejected because it exceeded the local max batch count) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">leader_&#8203;state_&#8203;enqueued</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Leader-state message accepted by gRPC stream_send) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">leader_&#8203;state_&#8203;no_&#8203;stream</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Leader-state send skipped because stream is unavailable (not established or not live)) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">leader_&#8203;state_&#8203;enqueue_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Leader-state send attempted but fd_grpc_client_stream_send returned failure) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">result_&#8203;enqueued</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Result message accepted by gRPC stream_send) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">result_&#8203;no_&#8203;stream</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Result send skipped because stream is unavailable (not established or not live)) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">result_&#8203;enqueue_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Result send attempted but fd_grpc_client_stream_send returned failure) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">heartbeat_&#8203;enqueued</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Validator heartbeat message accepted by gRPC stream_send) |
| <span class="metrics-name">bam_&#8203;outbound_&#8203;enqueue_&#8203;outcome</span><br/>{bam_&#8203;enqueue_&#8203;outcome="<span class="metrics-enum">heartbeat_&#8203;enqueue_&#8203;fail</span>"} | counter | Cumulative number of BAM outbound leader-state/result enqueue outcomes and heartbeat stream_send outcomes at the gRPC send boundary (Validator heartbeat send attempted on a live scheduler stream but fd_grpc_client_stream_send returned failure) |
...
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">client_&#8203;reset</span>"} | counter | Cumulative number of pending leader-state updates cleared before send because the BAM client reset, the scheduler request failed, or the stream ended/timed out (Pending leader-state cleared because BAM client was reset) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">request_&#8203;failed</span>"} | counter | Cumulative number of pending leader-state updates cleared before send because the BAM client reset, the scheduler request failed, or the stream ended/timed out (Pending leader-state cleared because scheduler stream request failed) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">stream_&#8203;ended</span>"} | counter | Cumulative number of pending leader-state updates cleared before send because the BAM client reset, the scheduler request failed, or the stream ended/timed out (Pending leader-state cleared because scheduler stream ended) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;dropped</span><br/>{bam_&#8203;leader_&#8203;pending_&#8203;drop_&#8203;reason="<span class="metrics-enum">stream_&#8203;timeout</span>"} | counter | Cumulative number of pending leader-state updates cleared before send because the BAM client reset, the scheduler request failed, or the stream ended/timed out (Pending leader-state cleared because scheduler stream timed out) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;state_&#8203;suppressed</span><br/>{bam_&#8203;leader_&#8203;state_&#8203;suppress_&#8203;reason="<span class="metrics-enum">not_&#8203;leader</span>"} | counter | Cumulative number of pack-provided BAM leader-state updates suppressed or cleared because the state was not locally live (Leader-state send suppressed because pack reported no active leader slot) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;state_&#8203;suppressed</span><br/>{bam_&#8203;leader_&#8203;state_&#8203;suppress_&#8203;reason="<span class="metrics-enum">expired</span>"} | counter | Cumulative number of pack-provided BAM leader-state updates suppressed or cleared because the state was not locally live (Leader-state send suppressed because slot_end_ns was known and already elapsed) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;state_&#8203;suppressed</span><br/>{bam_&#8203;leader_&#8203;state_&#8203;suppress_&#8203;reason="<span class="metrics-enum">slot_&#8203;regression</span>"} | counter | Cumulative number of pack-provided BAM leader-state updates suppressed or cleared because the state was not locally live (Leader-state send suppressed because the incoming slot regressed behind the latest local leader-state slot) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;state_&#8203;suppressed</span><br/>{bam_&#8203;leader_&#8203;state_&#8203;suppress_&#8203;reason="<span class="metrics-enum">scheduler_&#8203;rejected</span>"} | counter | Cumulative number of pack-provided BAM leader-state updates suppressed or cleared because the state was not locally live (Retained leader state cleared because the scheduler rejected it as outside the valid slot range) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;pending_&#8203;replaced</span> | counter | Cumulative number of pending leader-state updates replaced by a newer leader-state update before send |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">no_&#8203;ingress</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end or as unresolved when no slot attribution was available (No BAM ingress was observed for the slot before its debug retention window expired) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">first_&#8203;before_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end or as unresolved when no slot attribution was available (The first BAM ingress observed for the slot arrived before slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">first_&#8203;after_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end or as unresolved when no slot attribution was available (The first BAM ingress observed for the slot arrived after slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">unknown_&#8203;slot_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end or as unresolved when no slot attribution was available (BAM ingress was observed for the slot but slot_end_ns was unavailable when the slot aged out of the retention window) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">unresolved_&#8203;slot</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end or as unresolved when no slot attribution was available (BAM ingress was observed before any leader-slot attribution was available and was finalized without assigning it to a slot) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">before_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized ingress rollups using scheduler-receive callback timestamps, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown or unresolved when no slot attribution was available (BAM ingress transactions observed before slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">after_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized ingress rollups using scheduler-receive callback timestamps, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown or unresolved when no slot attribution was available (BAM ingress transactions observed after slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">unknown_&#8203;slot_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized ingress rollups using scheduler-receive callback timestamps, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown or unresolved when no slot attribution was available (BAM ingress transactions observed while slot_end_ns was unavailable) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">unresolved_&#8203;slot</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized ingress rollups using scheduler-receive callback timestamps, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown or unresolved when no slot attribution was available (BAM ingress transactions observed before any leader-slot attribution was available) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status</span><br/>{bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status="<span class="metrics-enum">disabled</span>"} | counter | Cumulative number of local leader slots whose slot_end_ns was observed and recorded, bucketed by BAM client status at slot end reconstructed from the local BAM status history (Local leader slot end recorded while BAM was disabled) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status</span><br/>{bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status="<span class="metrics-enum">disconnected</span>"} | counter | Cumulative number of local leader slots whose slot_end_ns was observed and recorded, bucketed by BAM client status at slot end reconstructed from the local BAM status history (Local leader slot end recorded while BAM was disconnected) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status</span><br/>{bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status="<span class="metrics-enum">connecting</span>"} | counter | Cumulative number of local leader slots whose slot_end_ns was observed and recorded, bucketed by BAM client status at slot end reconstructed from the local BAM status history (Local leader slot end recorded while BAM was still connecting) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status</span><br/>{bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status="<span class="metrics-enum">connected_&#8203;unhealthy</span>"} | counter | Cumulative number of local leader slots whose slot_end_ns was observed and recorded, bucketed by BAM client status at slot end reconstructed from the local BAM status history (Local leader slot end recorded while BAM transport and stream were up but heartbeat/config health was not yet healthy) |
| <span class="metrics-name">bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status</span><br/>{bam_&#8203;leader_&#8203;slot_&#8203;end_&#8203;status="<span class="metrics-enum">connected_&#8203;healthy</span>"} | counter | Cumulative number of local leader slots whose slot_end_ns was observed and recorded, bucketed by BAM client status at slot end reconstructed from the local BAM status history (Local leader slot end recorded while BAM was fully healthy and owned TPU ingress) |
| <span class="metrics-name">bam_&#8203;healthy_&#8203;leader_&#8203;slot_&#8203;result</span><br/>{bam_&#8203;healthy_&#8203;leader_&#8203;slot_&#8203;result="<span class="metrics-enum">fresh_&#8203;work</span>"} | counter | Cumulative number of local leader slots that reached slot_end_ns while BAM status was CONNECTED_HEALTHY, bucketed by whether fresh current-slot BAM work had arrived before slot end (Healthy BAM-owned leader slot ended after fresh current-slot BAM work arrived before slot end) |
| <span class="metrics-name">bam_&#8203;healthy_&#8203;leader_&#8203;slot_&#8203;result</span><br/>{bam_&#8203;healthy_&#8203;leader_&#8203;slot_&#8203;result="<span class="metrics-enum">no_&#8203;fresh_&#8203;work</span>"} | counter | Cumulative number of local leader slots that reached slot_end_ns while BAM status was CONNECTED_HEALTHY, bucketed by whether fresh current-slot BAM work had arrived before slot end (Healthy BAM-owned leader slot ended without fresh current-slot BAM work arriving before slot end) |
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">no_&#8203;live_&#8203;stream</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips, local send-boundary contention, and live-stream fd_grpc_client_stream_send results (Scheduler Ping arrived while no live scheduler stream was available for a Pong send attempt) |
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">enqueued</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips, local send-boundary contention, and live-stream fd_grpc_client_stream_send results (Pong message was accepted by fd_grpc_client_stream_send on a live scheduler stream) |
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">frame_&#8203;tx_&#8203;busy</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips, local send-boundary contention, and live-stream fd_grpc_client_stream_send results (Scheduler Ping arrived on a live stream but the local HTTP/2 TX frame buffer was not empty, so Pong was skipped) |
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">request_&#8203;busy</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips, local send-boundary contention, and live-stream fd_grpc_client_stream_send results (Scheduler Ping arrived on a live stream but a gRPC request body was still sending, so Pong was skipped) |
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">send_&#8203;fail</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips, local send-boundary contention, and live-stream fd_grpc_client_stream_send results (Pong send was attempted on a live scheduler stream after local readiness checks but fd_grpc_client_stream_send returned failure) |
...
| <span class="metrics-name">bam_&#8203;keepalive_&#8203;rtt_&#8203;valid</span> | gauge | Boolean gauge: 1 after the first HTTP/2 keepalive RTT sample has been observed, 0 before RTT estimates are initialized |
| <span class="metrics-name">bam_&#8203;feedback_&#8203;queue_&#8203;depth</span> | gauge | Current number of BAM feedback results buffered for send |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state</span><br/>{bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state="<span class="metrics-enum">no_&#8203;ingress</span>"} | gauge | One-hot state for the current leader slot's first observed scheduler-receive callback relative to slot end. Exactly one enum bucket is exported as 1 for the current local view; all others are 0. (No scheduler-receive callback has been observed yet for the current leader slot) |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state</span><br/>{bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state="<span class="metrics-enum">slot_&#8203;end_&#8203;unknown</span>"} | gauge | One-hot state for the current leader slot's first observed scheduler-receive callback relative to slot end. Exactly one enum bucket is exported as 1 for the current local view; all others are 0. (A first scheduler-receive callback was observed for the current leader slot but slot_end_ns is not known yet) |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state</span><br/>{bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state="<span class="metrics-enum">before_&#8203;end</span>"} | gauge | One-hot state for the current leader slot's first observed scheduler-receive callback relative to slot end. Exactly one enum bucket is exported as 1 for the current local view; all others are 0. (The first scheduler-receive callback observed for the current leader slot arrived before slot end) |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state</span><br/>{bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state="<span class="metrics-enum">at_&#8203;end</span>"} | gauge | One-hot state for the current leader slot's first observed scheduler-receive callback relative to slot end. Exactly one enum bucket is exported as 1 for the current local view; all others are 0. (The first scheduler-receive callback observed for the current leader slot arrived exactly at slot end) |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state</span><br/>{bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;state="<span class="metrics-enum">after_&#8203;end</span>"} | gauge | One-hot state for the current leader slot's first observed scheduler-receive callback relative to slot end. Exactly one enum bucket is exported as 1 for the current local view; all others are 0. (The first scheduler-receive callback observed for the current leader slot arrived after slot end) |
| <span class="metrics-name">bam_&#8203;current_&#8203;leader_&#8203;slot_&#8203;first_&#8203;ingress_&#8203;minus_&#8203;slot_&#8203;end_&#8203;nanos</span> | gauge | Signed nanosecond delta between the current leader slot's first observed scheduler-receive callback and slot_end_ns. Negative means before slot end, 0 means exactly at slot end, positive means after slot end, and LONG_MIN means no first ingress has been observed yet or slot_end_ns is still unknown. |
...
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;nanos</span> | histogram | Distribution of local BAM scheduler Ping-to-Pong send-boundary turnaround from scheduler-message receive callback to local readiness classification or fd_grpc_client_stream_send outcome on a live scheduler stream (nanoseconds). This is local processing and send-boundary latency, not network RTT. |
