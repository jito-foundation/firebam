...
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;before_&#8203;end_&#8203;nanos</span> | histogram | Distribution of slot-end headroom for the first BAM work item accepted into pack during a leader slot when that first insert occurred before slot end (nanoseconds) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;after_&#8203;end_&#8203;nanos</span> | histogram | Distribution of lateness for the first BAM work item accepted into pack during a leader slot when that first insert occurred after slot end (nanoseconds) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;before_&#8203;end_&#8203;nanos</span> | histogram | Distribution of slot-end headroom for the first BAM work item scheduled during a leader slot when that first schedule occurred before slot end (nanoseconds) |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;after_&#8203;end_&#8203;nanos</span> | histogram | Distribution of lateness for the first BAM work item scheduled during a leader slot when that first schedule occurred after slot end (nanoseconds) |
...
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">transport</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (DNS, socket, connect, or stream I/O failure) |
...
| <span class="metrics-name">bam_&#8203;failure</span><br/>{bam_&#8203;failure="<span class="metrics-enum">timeout</span>"} | counter | Cumulative number of BAM control-plane or session failures by class. Scheduler payload and AtomicTxnBatch rejects are counted separately in bam_ingress_batch_rejected. (Request, keepalive, or heartbeat timeout) |
...
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">invalid_&#8203;batch</span>"} | counter | Cumulative number of scheduler-payload BAM ingress rejects by reason across AtomicTxnBatch validation and multiple_atomic_txn_batch wrapper checks. These rejects are disjoint from bam_failure. (Batch rejected because AtomicTxnBatch decode or structural validation failed) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">empty_&#8203;batch</span>"} | counter | Cumulative number of scheduler-payload BAM ingress rejects by reason across AtomicTxnBatch validation and multiple_atomic_txn_batch wrapper checks. These rejects are disjoint from bam_failure. (Batch rejected because it contained zero packets) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">vote_&#8203;transaction</span>"} | counter | Cumulative number of scheduler-payload BAM ingress rejects by reason across AtomicTxnBatch validation and multiple_atomic_txn_batch wrapper checks. These rejects are disjoint from bam_failure. (Batch rejected because it contained a simple vote transaction) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">non_&#8203;revert_&#8203;multi_&#8203;packet</span>"} | counter | Cumulative number of scheduler-payload BAM ingress rejects by reason across AtomicTxnBatch validation and multiple_atomic_txn_batch wrapper checks. These rejects are disjoint from bam_failure. (Batch rejected because a non-revert batch contained multiple packets) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">empty_&#8203;message</span>"} | counter | Cumulative number of scheduler-payload BAM ingress rejects by reason across AtomicTxnBatch validation and multiple_atomic_txn_batch wrapper checks. These rejects are disjoint from bam_failure. (Wrapper rejected because a multiple_atomic_txn_batch message contained zero batches) |
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;rejected</span><br/>{bam_&#8203;ingress_&#8203;batch_&#8203;reject_&#8203;reason="<span class="metrics-enum">overflow_&#8203;message</span>"} | counter | Cumulative number of scheduler-payload BAM ingress rejects by reason across AtomicTxnBatch validation and multiple_atomic_txn_batch wrapper checks. These rejects are disjoint from bam_failure. (Wrapper rejected because a multiple_atomic_txn_batch message exceeded the local max batch count) |
...
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;first_&#8203;before_&#8203;end_&#8203;nanos</span> | histogram | Distribution of slot-end headroom for the first BAM ingress observed in a slot when that first ingress arrived before slot end (nanoseconds) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;first_&#8203;after_&#8203;end_&#8203;nanos</span> | histogram | Distribution of lateness for the first BAM ingress observed in a slot when that first ingress arrived after slot end (nanoseconds) |
