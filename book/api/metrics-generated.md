...
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;items</span><br/>{pack_&#8203;bam_&#8203;work_&#8203;stage="<span class="metrics-enum">completed_&#8203;unlanded</span>"} | counter | Cumulative number of BAM work items observed at each pack lifecycle stage. Multi-transaction BAM bundles count as one item. (BAM work completed execution but at least one transaction did not land) |
