...
| <span class="metrics-name">bam_&#8203;ingress_&#8203;batch_&#8203;no_&#8203;max_&#8203;schedule_&#8203;slot_&#8203;provided</span> | counter | Cumulative number of AtomicTxnBatch entries for which BAM did not provide max_schedule_slot and decode normalized the protobuf zero value to the internal no-hint sentinel |
...
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">no_&#8203;live_&#8203;stream</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips and live-stream fd_grpc_client_stream_send results (Scheduler Ping arrived while no live scheduler stream was available for a Pong send attempt) |
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">enqueued</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips and live-stream fd_grpc_client_stream_send results (Pong message was accepted by fd_grpc_client_stream_send on a live scheduler stream) |
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome</span><br/>{bam_&#8203;scheduler_&#8203;pong_&#8203;send_&#8203;outcome="<span class="metrics-enum">enqueue_&#8203;fail</span>"} | counter | Cumulative number of BAM scheduler Ping-to-Pong send outcomes, including no-live-stream skips and live-stream fd_grpc_client_stream_send results (Pong send was attempted on a live scheduler stream but fd_grpc_client_stream_send returned failure) |
