...
| <span class="metrics-name">pack_&#8203;bam_&#8203;work_&#8203;rx_&#8203;to_&#8203;first_&#8203;schedule_&#8203;nanos</span> | histogram | Distribution of BAM scheduler-receive to first-schedule delay for a tracked BAM work item, sampled once on the first schedule event for that work item (nanoseconds) |
...
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">no_&#8203;ingress</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end (No BAM ingress was observed for the slot before its debug retention window expired) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">first_&#8203;before_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end (The first BAM ingress observed for the slot arrived before slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">first_&#8203;after_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end (The first BAM ingress observed for the slot arrived after slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;result</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;result="<span class="metrics-enum">unknown_&#8203;slot_&#8203;end</span>"} | counter | Cumulative number of BAM slot-ingress records finalized after they aged out of the local retention window, bucketed by the first scheduler-receive callback for that slot relative to slot end (BAM ingress was observed for the slot but slot_end_ns was unavailable when the slot aged out of the retention window) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">before_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized per-slot ingress rollups using scheduler-receive callback timestamps, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown (BAM ingress transactions observed before slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">after_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized per-slot ingress rollups using scheduler-receive callback timestamps, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown (BAM ingress transactions observed after slot end) |
| <span class="metrics-name">bam_&#8203;slot_&#8203;ingress_&#8203;transactions</span><br/>{bam_&#8203;slot_&#8203;ingress_&#8203;txn_&#8203;timing="<span class="metrics-enum">unknown_&#8203;slot_&#8203;end</span>"} | counter | Cumulative number of BAM ingress transactions counted in finalized per-slot ingress rollups using scheduler-receive callback timestamps, bucketed as before-end or after-end only when slot_end_ns was known at observation time, else unknown (BAM ingress transactions observed while slot_end_ns was unavailable) |
...
| <span class="metrics-name">bam_&#8203;scheduler_&#8203;pong_&#8203;enqueue_&#8203;nanos</span> | histogram | Distribution of local BAM scheduler Ping-to-Pong enqueue turnaround from scheduler-message receive callback to successful Pong enqueue (nanoseconds). This is local processing and enqueue latency, not network RTT. |
