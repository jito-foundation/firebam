...
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;recorded</span> | gauge | Boolean gauge: 1 when the current pack leader slot has observed a first BAM work-item insert, 0 otherwise |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;distance_&#8203;nanos</span> | gauge | Absolute distance in nanoseconds between the current pack leader slot's slot_end_ns and the first BAM work-item insert observed for that slot. Exported as 0 until a first insert has been observed |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;insert_&#8203;after_&#8203;end</span> | gauge | Boolean gauge: 1 when the first BAM work-item insert for the current pack leader slot arrived after slot end, 0 when it arrived before slot end or no first insert has been recorded yet |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;recorded</span> | gauge | Boolean gauge: 1 when the current pack leader slot has observed a first BAM work-item schedule event, 0 otherwise |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;distance_&#8203;nanos</span> | gauge | Absolute distance in nanoseconds between the current pack leader slot's slot_end_ns and the first BAM work-item schedule observed for that slot. Exported as 0 until a first schedule has been observed |
| <span class="metrics-name">pack_&#8203;bam_&#8203;leader_&#8203;slot_&#8203;first_&#8203;schedule_&#8203;after_&#8203;end</span> | gauge | Boolean gauge: 1 when the first BAM work-item schedule for the current pack leader slot occurred after slot end, 0 when it occurred before slot end or no first schedule has been recorded yet |
