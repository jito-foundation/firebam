...
| <span class="metrics-name">bam_&#8203;bundle_&#8203;published</span> | counter | Cumulative number of revert-on-error AtomicTxnBatch entries published to verify as BAM bundles |
...
| <span class="metrics-name">bam_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">request_&#8203;blocked</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because gRPC request path is blocked) |
| <span class="metrics-name">bam_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">stall_&#8203;backoff</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because reconnect backoff is active) |
| <span class="metrics-name">bam_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">not_&#8203;connected</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped while waiting for TCP connect progression) |
| <span class="metrics-name">bam_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">drive_&#8203;io_&#8203;fail</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because drive_io failed) |
| <span class="metrics-name">bam_&#8203;step_&#8203;skip</span><br/>{bam_&#8203;client_&#8203;step_&#8203;skip_&#8203;reason="<span class="metrics-enum">deferred_&#8203;reset</span>"} | counter | Cumulative number of BAM client-step skips by reason (Client step skipped because a deferred reset was pending) |
...
| <span class="metrics-name">bam_&#8203;node_&#8203;heartbeat_&#8203;network_&#8203;latency_&#8203;nanos</span> | histogram | Distribution of BAM node heartbeat timestamp to Frankendancer scheduler-stream receive callback time (nanoseconds); intended for relative trend analysis |
