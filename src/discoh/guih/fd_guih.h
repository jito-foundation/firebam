#ifndef HEADER_fd_src_discoh_guih_fd_guih_h
#define HEADER_fd_src_discoh_guih_fd_guih_h
...
/* frankendancer only */
#define FD_GUIH_MAX_PEER_CNT (108000UL)

/* frankendancer only */
#define FD_GUIH_START_PROGRESS_TYPE_INITIALIZING                       ( 0)
#define FD_GUIH_START_PROGRESS_TYPE_SEARCHING_FOR_FULL_SNAPSHOT        ( 1)
#define FD_GUIH_START_PROGRESS_TYPE_DOWNLOADING_FULL_SNAPSHOT          ( 2)
#define FD_GUIH_START_PROGRESS_TYPE_SEARCHING_FOR_INCREMENTAL_SNAPSHOT ( 3)
#define FD_GUIH_START_PROGRESS_TYPE_DOWNLOADING_INCREMENTAL_SNAPSHOT   ( 4)
#define FD_GUIH_START_PROGRESS_TYPE_CLEANING_BLOCK_STORE               ( 5)
#define FD_GUIH_START_PROGRESS_TYPE_CLEANING_ACCOUNTS                  ( 6)
#define FD_GUIH_START_PROGRESS_TYPE_LOADING_LEDGER                     ( 7)
#define FD_GUIH_START_PROGRESS_TYPE_PROCESSING_LEDGER                  ( 8)
#define FD_GUIH_START_PROGRESS_TYPE_STARTING_SERVICES                  ( 9)
#define FD_GUIH_START_PROGRESS_TYPE_HALTED                             (10)
#define FD_GUIH_START_PROGRESS_TYPE_WAITING_FOR_SUPERMAJORITY          (11)
#define FD_GUIH_START_PROGRESS_TYPE_RUNNING                            (12)

#define FD_GUIH_NETWORK_EMA_HALF_LIFE_NS (1000000000L) /* 1 second in nanoseconds */
#define FD_GUIH_NET_PROTO_CNT            (6UL)         /* turbine, gossip, tpu, repair, rserve, metric */
#define FD_GUIH_NET_RATE_MAX_WINDOW_NS   (300L*1000L*1000L*1000L) /* 5 minutes in nanoseconds */

/* fd_guih_ema computes an adaptive exponential moving average tick.
...
fd_guih_ema( long   last_update_nanos,
             long   now_nanos,
             double new_sample,
             double prev_ema,
             long   half_life_ns ) {
...
struct fd_guih_rate_entry {
  long   ts_nanos;
  double value;
};
typedef struct fd_guih_rate_entry fd_guih_rate_entry_t;

/* At 100 ms sampling, 5 minutes = 3000 samples. */
#define DEQUE_NAME fd_guih_rate_deque
#define DEQUE_T    fd_guih_rate_entry_t
...
#define FD_GUIH_SLOT_LEADER_STARTED   (1UL)
#define FD_GUIH_SLOT_LEADER_ENDED     (2UL)

#define FD_GUIH_SLOTS_CNT                           (864000UL) /* 2x 432000 */
#define FD_GUIH_LEADER_CNT                          (4096UL)

#define FD_GUIH_TPS_HISTORY_WINDOW_DURATION_SECONDS (10L)
#define FD_GUIH_TPS_HISTORY_SAMPLE_CNT              (150UL)

#define FD_GUIH_PROGCACHE_HISTORY_CNT               (600UL) /* 60s / 100ms */

#define FD_GUIH_TILE_TIMER_SNAP_CNT                   (512UL)
#define FD_GUIH_TILE_TIMER_LEADER_DOWNSAMPLE_CNT      (50UL)  /* 500ms / 10ms */
#define FD_GUIH_SCHEDULER_COUNT_SNAP_CNT              (512UL)
#define FD_GUIH_SCHEDULER_COUNT_LEADER_DOWNSAMPLE_CNT (50UL)  /* 500ms / 10ms */

#define FD_GUIH_VOTE_STATE_NON_VOTING (0)
#define FD_GUIH_VOTE_STATE_VOTING     (1)
#define FD_GUIH_VOTE_STATE_DELINQUENT (2)

#define FD_GUIH_BOOT_PROGRESS_TYPE_JOINING_GOSSIP               (1)
#define FD_GUIH_BOOT_PROGRESS_TYPE_LOADING_FULL_SNAPSHOT        (2)
#define FD_GUIH_BOOT_PROGRESS_TYPE_LOADING_INCREMENTAL_SNAPSHOT (3)
#define FD_GUIH_BOOT_PROGRESS_TYPE_WAITING_FOR_SUPERMAJORITY    (4)
#define FD_GUIH_BOOT_PROGRESS_TYPE_CATCHING_UP                  (5)
#define FD_GUIH_BOOT_PROGRESS_TYPE_RUNNING                      (6)

#define FD_GUIH_BOOT_PROGRESS_FULL_SNAPSHOT_IDX        (0UL)
#define FD_GUIH_BOOT_PROGRESS_INCREMENTAL_SNAPSHOT_IDX (1UL)
#define FD_GUIH_BOOT_PROGRESS_SNAPSHOT_CNT             (2UL)

#define FD_GUIH_SLOT_LEVEL_INCOMPLETE               (0)
#define FD_GUIH_SLOT_LEVEL_COMPLETED                (1)
#define FD_GUIH_SLOT_LEVEL_OPTIMISTICALLY_CONFIRMED (2)
#define FD_GUIH_SLOT_LEVEL_ROOTED                   (3)
#define FD_GUIH_SLOT_LEVEL_FINALIZED                (4)
...
#define FD_GUIH_TXN_HISTORY_SZ (1UL<<26UL)

#define FD_GUIH_TXN_FLAGS_STARTED         ( 1U)
#define FD_GUIH_TXN_FLAGS_ENDED           ( 2U)
#define FD_GUIH_TXN_FLAGS_IS_SIMPLE_VOTE  ( 4U)
#define FD_GUIH_TXN_FLAGS_FROM_BUNDLE     ( 8U)
#define FD_GUIH_TXN_FLAGS_LANDED_IN_BLOCK (16U)

#define FD_GUIH_TURBINE_RECV_TIMESTAMPS (750UL)
...
/* One use case for tracking ingress shred slot is to estimate when we
   ...
   problems. */
#define FD_GUIH_TURBINE_SLOT_HISTORY_SZ (  12UL )
...
/* Like the turbine slot, the latest repair slot can also swing to
   ...
   during catch up. */
#define FD_GUIH_REPAIR_SLOT_HISTORY_SZ  ( 512UL )

/* FD_GUIH_*_CATCH_UP_HISTORY_SZ is the capacity of the record of slots
...
#define FD_GUIH_REPAIR_CATCH_UP_HISTORY_SZ  (4096UL)
#define FD_GUIH_TURBINE_CATCH_UP_HISTORY_SZ (4096UL)

/* FD_GUIH_SHREDS_STAGING_SZ is number of shred events we'll retain in
...
#define FD_GUIH_MAX_SHREDS_PER_BLOCK  (32UL*1024UL)
#define FD_GUIH_MAX_EVENTS_PER_SHRED  (       32UL)
#define FD_GUIH_SHREDS_STAGING_SZ     (32UL * FD_GUIH_MAX_SHREDS_PER_BLOCK * FD_GUIH_MAX_EVENTS_PER_SHRED)

/* FD_GUIH_SHREDS_HISTORY_SZ the number of shred events in our historical
   ...
   bound heuristically. */
#define FD_GUIH_SHREDS_HISTORY_SZ     (432000UL*2000UL*4UL / 12UL)

#define FD_GUIH_SLOT_SHRED_REPAIR_REQUEST          (0UL)
#define FD_GUIH_SLOT_SHRED_SHRED_RECEIVED_TURBINE  (1UL)
#define FD_GUIH_SLOT_SHRED_SHRED_RECEIVED_REPAIR   (2UL)
#define FD_GUIH_SLOT_SHRED_SHRED_REPLAY_EXEC_DONE  (3UL)
#define FD_GUIH_SLOT_SHRED_SHRED_SLOT_COMPLETE     (4UL)
/* #define FD_GUIH_SLOT_SHRED_SHRED_REPLAY_EXEC_START (5UL) // UNUSED */
#define FD_GUIH_SLOT_SHRED_SHRED_PUBLISHED         (6UL)

#define FD_GUIH_SLOT_RANKINGS_SZ (100UL)
#define FD_GUIH_SLOT_RANKING_TYPE_ASC  (0)
#define FD_GUIH_SLOT_RANKING_TYPE_DESC (1)

struct fd_guih_tile_timers {
...
struct fd_guih_scheduler_counts {
  long sample_time_ns;
  ulong regular;
  ulong votes;
  ulong conflicting;
...
typedef struct fd_guih_scheduler_counts fd_guih_scheduler_counts_t;

struct fd_guih_network_stats {
...
typedef struct fd_guih_network_stats fd_guih_network_stats_t;

struct fd_guih_leader_slot {
  ulong slot;
  ...
  /* Stem tiles can exist in one of 8 distinct activity regimes at any
     ...
     FD_GUIH_TILE_TIMER_SNAP_CNT. The sample index is recorded at the
     start and end of a leader slot, and the number of samples is
     downsampled to be at most FD_GUIH_TILE_TIMER_LEADER_DOWNSAMPLE_CNT
     samples (e.g. if there was an unusually long leader slot) and
     inserted into historical storage with capacity FD_GUIH_LEADER_CNT.

     The tile_timers pointer references trailing storage allocated
     in fd_guih_footprint, with gui->tile_cnt elements per sample.
     Sized as tile_timers[ FD_GUIH_TILE_TIMER_LEADER_DOWNSAMPLE_CNT ][ tile_cnt ]. */
  fd_guih_tile_timers_t * tile_timers;
  ulong                  tile_timers_sample_cnt;

  fd_guih_scheduler_counts_t scheduler_counts[ FD_GUIH_SCHEDULER_COUNT_LEADER_DOWNSAMPLE_CNT ][ 1 ];
  ...
  struct {
    ...
    ulong   start_offset; /* The smallest pack transaction index for this slot. The first transaction for this slot will
                             be written to gui->txs[ start_offset%FD_GUIH_TXN_HISTORY_SZ ]. */
    ulong   end_offset;   /* The largest pack transaction index for this slot, plus 1. The last transaction for this
                             slot will be written to gui->txs[ (end_offset-1)%FD_GUIH_TXN_HISTORY_SZ ]. */
  } txs;
...
typedef struct fd_guih_leader_slot fd_guih_leader_slot_t;

struct fd_guih_turbine_slot {
 ulong slot;
 long timestamp;
};

typedef struct fd_guih_turbine_slot fd_guih_turbine_slot_t;

struct fd_guih_slot_staged_shred_event {
  long   timestamp;
  ulong  slot;
  ushort shred_idx;
  uchar  event;
...
typedef struct fd_guih_slot_history_shred_event fd_guih_slot_history_shred_event_t;
...
typedef struct fd_guih_slot_ranking fd_guih_slot_ranking_t;

struct fd_guih_slot_rankings {
  fd_guih_slot_ranking_t largest_tips           [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t largest_fees           [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t largest_rewards        [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t largest_duration       [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t largest_compute_units  [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t largest_skipped        [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t largest_rewards_per_cu [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t smallest_tips          [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t smallest_fees          [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t smallest_rewards       [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t smallest_rewards_per_cu[ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t smallest_duration      [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t smallest_compute_units [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
  fd_guih_slot_ranking_t smallest_skipped       [ FD_GUIH_SLOT_RANKINGS_SZ+1UL ];
};

typedef struct fd_guih_slot_rankings fd_guih_slot_rankings_t;

struct fd_guih_ephemeral_slot {
...
struct __attribute__((packed)) fd_guih_txn {
  ...
  uchar flags; /* assigned with the FD_GUIH_TXN_FLAGS_* macros */
  uchar source_tpu; /* FD_TXN_M_TPU_SOURCE_* */
  uint  source_ipv4;
  uint  microblock_idx;
};

typedef struct fd_guih_txn fd_guih_txn_t;

struct fd_guih_txn_waterfall {
  struct {
    ulong quic;
    ulong udp;
    ulong gossip;
...
typedef struct fd_guih_txn_waterfall fd_guih_txn_waterfall_t;

struct fd_guih_tile_stats {
...
typedef struct fd_guih_tile_stats fd_guih_tile_stats_t;
...
struct fd_guih_slot {
  ...
  fd_guih_txn_waterfall_t waterfall_begin[ 1 ];
  fd_guih_txn_waterfall_t waterfall_end[ 1 ];

  fd_guih_tile_stats_t tile_stats_begin[ 1 ];
  fd_guih_tile_stats_t tile_stats_end[ 1 ];

  struct {
    ulong start_offset; /* gui->shreds.history[ start_offset % FD_GUIH_SHREDS_HISTORY_SZ ] is the first shred event in
...
typedef struct fd_guih_slot fd_guih_slot_t;

struct fd_guih_boot_progress {
  uchar phase;
  ...
  } loading_snapshot[ FD_GUIH_BOOT_PROGRESS_SNAPSHOT_CNT ];
...
typedef struct fd_guih_boot_progress fd_guih_boot_progress_t;
...
struct fd_guih {
  ...
  struct {
    ...
    union {
      ...
      fd_guih_boot_progress_t boot_progress;
    };

    fd_guih_boot_progress_t prev_boot_progress;
    ...
    fd_guih_ephemeral_slot_t slots_max_turbine[ FD_GUIH_TURBINE_SLOT_HISTORY_SZ+1UL ];
    fd_guih_ephemeral_slot_t slots_max_repair [ FD_GUIH_REPAIR_SLOT_HISTORY_SZ +1UL ];

    /* catchup_* and late_votes are run-length encoded. i.e. adjacent
       pairs represent contiguous runs */
    ulong catch_up_turbine[ FD_GUIH_TURBINE_CATCH_UP_HISTORY_SZ ];
    ...
    } estimated_tps_history[ FD_GUIH_TPS_HISTORY_SAMPLE_CNT ];

    fd_guih_network_stats_t network_stats_current[ 1 ];
    fd_guih_network_stats_t network_stats_prev[ 1 ];
    int                    network_stats_has_prev;

    /* EMA-smoothed network throughput (bytes/sec) with a 1-second
       half-life. */
    double                   ingress_ema[ FD_GUIH_NET_PROTO_CNT ];
    double                   egress_ema[ FD_GUIH_NET_PROTO_CNT ];
    long                     net_rate_prev_ts;
    int                      net_rate_ema_ready;
    fd_guih_rate_entry_t *    ingress_maxq;
    fd_guih_rate_entry_t *    egress_maxq;

    fd_guih_txn_waterfall_t txn_waterfall_reference[ 1 ];
    fd_guih_txn_waterfall_t txn_waterfall_current[ 1 ];

    fd_guih_tile_stats_t tile_stats_reference[ 1 ];
    fd_guih_tile_stats_t tile_stats_current[ 1 ];

    ulong progcache_history_idx;
    ulong progcache_hits_history   [ FD_GUIH_PROGCACHE_HISTORY_CNT ];
    ulong progcache_lookups_history[ FD_GUIH_PROGCACHE_HISTORY_CNT ];
    ...
    /* Temporary storage for samples.  Will be downsampled into
       ...
       tile_timers_snap[ FD_GUIH_TILE_TIMER_SNAP_CNT ][ tile_cnt ] */
    fd_guih_tile_timers_t * tile_timers_snap;
    ...
    fd_guih_scheduler_counts_t scheduler_counts_snap[ FD_GUIH_SCHEDULER_COUNT_SNAP_CNT ][ 1 ];
  } summary;

  fd_guih_slot_t slots[ FD_GUIH_SLOTS_CNT ][ 1 ];

  /* used for estimating slot duration */
  fd_guih_turbine_slot_t turbine_slots[ FD_GUIH_TURBINE_RECV_TIMESTAMPS ];

  fd_guih_leader_slot_t leader_slots[ FD_GUIH_LEADER_CNT ][ 1 ];
  ulong leader_slots_cnt;

  fd_guih_txn_t txs[ FD_GUIH_TXN_HISTORY_SZ ][ 1 ];
  ...
  struct {
    ...
    struct {
      ...
      fd_guih_slot_rankings_t my_rankings[ 1 ]; /* my slots only */
    } epochs[ 2 ];
  } epoch;

  struct {  /* frankendancer only */
    ulong                     peer_cnt;
    struct fd_guih_gossip_peer peers[ FD_GUIH_MAX_PEER_CNT ];
  } gossip;
  ...
  struct {  /* frankendancer only */
    ulong                        info_cnt;
    struct fd_guih_validator_info info[ FD_GUIH_MAX_PEER_CNT ];
  } validator_info;
  ...
  struct {
    ...
    ulong staged_next_broadcast; /* staged[ staged_next_broadcast % FD_GUIH_SHREDS_STAGING_SZ ] is the first shred event
                                    that hasn't yet been broadcast to WebSocket clients */
    ulong staged_head;            /* staged_head % FD_GUIH_SHREDS_STAGING_SZ is the first valid event in staged */
    ulong staged_tail;            /* staged_tail % FD_GUIH_SHREDS_STAGING_SZ is one past the last valid event in staged */
    fd_guih_slot_staged_shred_event_t  staged [ FD_GUIH_SHREDS_STAGING_SZ ];

    ulong history_slot;          /* the largest slot store in history */
    ulong history_tail;          /* history_tail % FD_GUIH_SHREDS_HISTORY_SZ is one past the last valid event in history */
    fd_guih_slot_history_shred_event_t history[ FD_GUIH_SHREDS_HISTORY_SZ ];

    /* scratch space for archiving staged events */
    fd_guih_slot_staged_shred_event_t _staged_scratch [ FD_GUIH_SHREDS_STAGING_SZ ];
  } shreds; /* full client */
};

typedef struct fd_guih fd_guih_t;

/* fd_guih_staged_push returns a pointer to the next free staging slot
   and advances staged_tail.  If the ring is full staged_head is
   advanced first so the oldest entry is silently dropped. */
static inline fd_guih_slot_staged_shred_event_t *
fd_guih_staged_push( fd_guih_t * gui ) {
  if( FD_UNLIKELY( gui->shreds.staged_tail - gui->shreds.staged_head >= FD_GUIH_SHREDS_STAGING_SZ ) ) {
    gui->shreds.staged_head = gui->shreds.staged_tail - FD_GUIH_SHREDS_STAGING_SZ + 1UL;
  ...
  fd_guih_slot_staged_shred_event_t * dst =
      &gui->shreds.staged[ gui->shreds.staged_tail % FD_GUIH_SHREDS_STAGING_SZ ];
...
static inline ulong
fd_guih_current_epoch_idx( fd_guih_t * gui ) {
...
static inline fd_guih_slot_t *
fd_guih_get_slot( fd_guih_t const * gui, ulong _slot ) {
  fd_guih_slot_t const * slot = gui->slots[ _slot % FD_GUIH_SLOTS_CNT ];
  if( FD_UNLIKELY( slot->slot==ULONG_MAX || _slot==ULONG_MAX || slot->slot!=_slot ) ) return NULL;
  return (fd_guih_slot_t *)slot;
}

static inline fd_guih_slot_t const *
fd_guih_get_slot_const( fd_guih_t const * gui, ulong _slot ) {
  return fd_guih_get_slot( gui, _slot );
}

static inline fd_guih_leader_slot_t *
fd_guih_get_leader_slot( fd_guih_t const * gui, ulong _slot ) {
  fd_guih_slot_t const * slot = fd_guih_get_slot( gui, _slot );
  if( FD_UNLIKELY( !slot
                || !slot->mine
                || slot->leader_history_idx==ULONG_MAX
                || slot->leader_history_idx + FD_GUIH_LEADER_CNT < gui->leader_slots_cnt
                || gui->leader_slots[ slot->leader_history_idx % FD_GUIH_LEADER_CNT ]->slot!=_slot ) ) return NULL;
  return (fd_guih_leader_slot_t *)gui->leader_slots[ slot->leader_history_idx % FD_GUIH_LEADER_CNT ];
}

static inline fd_guih_leader_slot_t const *
fd_guih_get_leader_slot_const( fd_guih_t const * gui, ulong _slot ) {
  return fd_guih_get_leader_slot( gui, _slot );
}

/* fd_guih_get_root_slot returns a handle to the closest ancestor of slot
   that is a root, if available, otherwise NULL. */
static inline fd_guih_slot_t *
fd_guih_get_root_slot( fd_guih_t const * gui,
                      ulong            slot ) {
  fd_guih_slot_t * c = fd_guih_get_slot( gui, slot );
  while( c ) {
    if( FD_UNLIKELY( c->level>=FD_GUIH_SLOT_LEVEL_ROOTED ) ) return c;
    c = fd_guih_get_slot( gui, c->parent_slot );
  }
  return NULL;
}

/* fd_guih_slot_is_ancestor returns 1 if anc is known to be an ancestor
   of slot (on the same fork), 0 otherwise. */
static inline int
fd_guih_slot_is_ancestor( fd_guih_t const * gui,
                         ulong            anc,
                         ulong            slot ) {
  fd_guih_slot_t * c = fd_guih_get_slot( gui, slot );
  while( c ) {
...
/* fd_guih_get_parent_slot_on_fork returns a handle to the parent of slot
   ...
   unknown. */
static inline fd_guih_slot_t *
fd_guih_get_parent_slot_on_fork( fd_guih_t const * gui,
                                ulong            frontier_slot,
                                ulong            slot ) {
  fd_guih_slot_t * c = fd_guih_get_slot( gui, frontier_slot );
  while( c ) {
    if( FD_UNLIKELY( c->slot<=slot ) ) return NULL;
    fd_guih_slot_t * p = fd_guih_get_slot( gui, c->parent_slot );
...
/* fd_guih_is_skipped_on_fork returns 1 if slot is skipped on the fork
   starting at anc and ending at des, 0 otherwise. */
static inline int
fd_guih_is_skipped_on_fork( fd_guih_t const * gui,
                           ulong            anc,
                           ulong            des,
                           ulong            slot ) {
  fd_guih_slot_t const * c = fd_guih_get_slot( gui, des );
  while( c ) {
    if( FD_UNLIKELY( anc==c->slot ) ) return 0; /* on the fork, not skipped */
    fd_guih_slot_t const * p = fd_guih_get_slot( gui, c->parent_slot );
...
#endif /* HEADER_fd_src_discoh_guih_fd_guih_h */
