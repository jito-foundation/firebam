...
const fd_metrics_meta_t FD_METRICS_PACK[FD_METRICS_PACK_TOTAL] = {
    ...
    DECLARE_METRIC_ENUM( PACK_BAM_BUNDLE_ABANDON, COUNTER, PACK_BAM_BUNDLE_ABANDON_REASON, NEW_SEQ_BEFORE_COMPLETE ),
    DECLARE_METRIC_ENUM( PACK_BAM_BUNDLE_ABANDON, COUNTER, PACK_BAM_BUNDLE_ABANDON_REASON, LEADER_SLOT_END ),
    DECLARE_METRIC_ENUM( PACK_BAM_BUNDLE_ABANDON, COUNTER, PACK_BAM_BUNDLE_ABANDON_REASON, OUTSIDE_LEADER_SLOT ),
    DECLARE_METRIC_ENUM( PACK_BAM_BUNDLE_ABANDON, COUNTER, PACK_BAM_BUNDLE_ABANDON_REASON, POH_TIMEOUT ),
    DECLARE_METRIC_ENUM( PACK_BAM_SINGLE_TXN_INVALID, COUNTER, PACK_BAM_SINGLE_TXN_INVALID_REASON, OUTSIDE_SLOT ),
    DECLARE_METRIC_ENUM( PACK_BAM_SINGLE_TXN_INVALID, COUNTER, PACK_BAM_SINGLE_TXN_INVALID_REASON, BLOCKHASH_EXPIRED ),
