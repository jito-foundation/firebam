...
const fd_metrics_meta_t FD_METRICS_PACK[FD_METRICS_PACK_TOTAL] = {
    ...
    DECLARE_METRIC_HISTOGRAM_NONE( PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS ),
    DECLARE_METRIC_HISTOGRAM_NONE( PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS ),
    DECLARE_METRIC_HISTOGRAM_NONE( PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS ),
    DECLARE_METRIC_HISTOGRAM_NONE( PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS ),
