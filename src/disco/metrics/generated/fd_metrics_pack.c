...
const fd_metrics_meta_t FD_METRICS_PACK[FD_METRICS_PACK_TOTAL] = {
    ...
    DECLARE_METRIC( PACK_BAM_LEADER_SLOT_FIRST_INSERT_RECORDED, GAUGE ),
    DECLARE_METRIC( PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS, GAUGE ),
    DECLARE_METRIC( PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END, GAUGE ),
    DECLARE_METRIC( PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RECORDED, GAUGE ),
    DECLARE_METRIC( PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS, GAUGE ),
    DECLARE_METRIC( PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END, GAUGE ),
