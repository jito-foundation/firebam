...
enum {
  FD_METRICS_COUNTER_LINK_CONSUMED_COUNT_OFF,
  FD_METRICS_COUNTER_LINK_CONSUMED_SIZE_BYTES_OFF,
  FD_METRICS_COUNTER_LINK_FILTERED_COUNT_OFF,
  FD_METRICS_COUNTER_LINK_FILTERED_SIZE_BYTES_OFF,
  FD_METRICS_COUNTER_LINK_OVERRUN_POLLING_COUNT_OFF,
  FD_METRICS_COUNTER_LINK_OVERRUN_POLLING_FRAG_COUNT_OFF,
  FD_METRICS_COUNTER_LINK_OVERRUN_READING_COUNT_OFF,
  FD_METRICS_COUNTER_LINK_OVERRUN_READING_FRAG_COUNT_OFF,
  FD_METRICS_COUNTER_LINK_SLOW_COUNT_OFF,
};
...
enum {
  ...
  FD_METRICS_COUNTER_TILE_CONTEXT_SWITCH_INVOLUNTARY_COUNT_OFF,
  FD_METRICS_COUNTER_TILE_CONTEXT_SWITCH_VOLUNTARY_COUNT_OFF,
  FD_METRICS_COUNTER_TILE_PAGE_FAULT_MAJOR_COUNT_OFF,
  FD_METRICS_COUNTER_TILE_PAGE_FAULT_MINOR_COUNT_OFF,
  FD_METRICS_GAUGE_TILE_STATUS_OFF,
  FD_METRICS_GAUGE_TILE_HEARTBEAT_OFF,
  FD_METRICS_GAUGE_TILE_IN_BACKPRESSURE_OFF,
  FD_METRICS_COUNTER_TILE_BACKPRESSURE_COUNT_OFF,
  ...
  FD_METRICS_COUNTER_TILE_IRQ_COUNT_OFF,
};
...
#define FD_METRICS_COUNTER_TILE_IRQ_COUNT_NAME "tile_irq_count"
#define FD_METRICS_COUNTER_TILE_IRQ_COUNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_TILE_IRQ_COUNT_DESC "The number of times this tile was interrupted by an IRQ (fixed tiles only)"
#define FD_METRICS_COUNTER_TILE_IRQ_COUNT_CVT  (FD_METRICS_CONVERTER_NONE)


#define FD_METRICS_ALL_TOTAL (24UL)
...
#define FD_METRICS_TOTAL_SZ (8UL*316UL)
