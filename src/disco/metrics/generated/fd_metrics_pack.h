...
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS_OFF  (211UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS_NAME "pack_bam_leader_slot_first_insert_before_end_nanos"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS_TYPE (FD_METRICS_TYPE_HISTOGRAM)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS_DESC "Distribution of slot-end headroom for the first BAM work item accepted into pack during a leader slot when that first insert occurred before slot end (nanoseconds)"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS_MIN  (0UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_BEFORE_END_NANOS_MAX  (1000000000UL)

#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS_OFF  (228UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS_NAME "pack_bam_leader_slot_first_insert_after_end_nanos"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS_TYPE (FD_METRICS_TYPE_HISTOGRAM)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS_DESC "Distribution of lateness for the first BAM work item accepted into pack during a leader slot when that first insert occurred after slot end (nanoseconds)"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS_MIN  (0UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NANOS_MAX  (1000000000UL)

#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS_OFF  (245UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS_NAME "pack_bam_leader_slot_first_schedule_before_end_nanos"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS_TYPE (FD_METRICS_TYPE_HISTOGRAM)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS_DESC "Distribution of slot-end headroom for the first BAM work item scheduled during a leader slot when that first schedule occurred before slot end (nanoseconds)"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS_MIN  (0UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_BEFORE_END_NANOS_MAX  (1000000000UL)

#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS_OFF  (262UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS_NAME "pack_bam_leader_slot_first_schedule_after_end_nanos"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS_TYPE (FD_METRICS_TYPE_HISTOGRAM)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS_DESC "Distribution of lateness for the first BAM work item scheduled during a leader slot when that first schedule occurred after slot end (nanoseconds)"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS_MIN  (0UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NANOS_MAX  (1000000000UL)

#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_OFF  (279UL)
...
#define FD_METRICS_GAUGE_PACK_CUS_CONSUMED_IN_BLOCK_OFF  (296UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_SCHEDULED_OFF  (297UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_REBATED_OFF  (314UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_NET_OFF  (331UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_PCT_OFF  (348UL)
...
#define FD_METRICS_COUNTER_PACK_DELETE_MISSED_OFF  (365UL)
...
#define FD_METRICS_COUNTER_PACK_DELETE_HIT_OFF  (366UL)
...
#define FD_METRICS_PACK_TOTAL (111UL)
