...
#define FD_METRICS_COUNTER_PACK_BAM_LEADER_SLOT_FIRST_INSERT_RESULT_DESC "Cumulative number of pack leader slots finalized with no BAM insert, a first BAM insert before slot end, or a first BAM insert after slot end"
...
#define FD_METRICS_COUNTER_PACK_BAM_LEADER_SLOT_FIRST_INSERT_RESULT_AFTER_END_OFF (215UL)

#define FD_METRICS_COUNTER_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RESULT_OFF  (216UL)
...
#define FD_METRICS_COUNTER_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RESULT_DESC "Cumulative number of pack leader slots finalized with no BAM schedule, a first BAM schedule before slot end, or a first BAM schedule after slot end"
...
#define FD_METRICS_COUNTER_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RESULT_NO_EVENT_OFF (216UL)
#define FD_METRICS_COUNTER_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RESULT_BEFORE_END_OFF (217UL)
#define FD_METRICS_COUNTER_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RESULT_AFTER_END_OFF (218UL)

#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_OFF  (219UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_NAME "pack_bam_leader_slot_first_insert_distance_nanos"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_TYPE (FD_METRICS_TYPE_HISTOGRAM)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_DESC "Absolute distance in nanoseconds between slot_end_ns and the first BAM insert observed for a finalized pack leader slot. Sampled once per slot only when an insert was observed."
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_MIN  (0UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_MAX  (10000000000UL)

#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_OFF  (236UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_NAME "pack_bam_leader_slot_first_schedule_distance_nanos"
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_TYPE (FD_METRICS_TYPE_HISTOGRAM)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_DESC "Absolute distance in nanoseconds between slot_end_ns and the first BAM schedule observed for a finalized pack leader slot. Sampled once per slot only when a schedule was observed."
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_MIN  (0UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_MAX  (10000000000UL)

#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_OFF  (253UL)
...
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_RECEIVED_OFF (253UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_ACCEPTED_OFF (254UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_REJECTED_PRE_PENDING_OFF (255UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_PENDING_OFF (256UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_EVICTED_POST_PENDING_OFF (257UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_SCHEDULED_OFF (258UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_ITEMS_LANDED_OFF (259UL)

#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_OFF  (260UL)
...
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_RECEIVED_OFF (260UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_ACCEPTED_OFF (261UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_REJECTED_PRE_PENDING_OFF (262UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_PENDING_OFF (263UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_EVICTED_POST_PENDING_OFF (264UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_SCHEDULED_OFF (265UL)
#define FD_METRICS_GAUGE_PACK_BAM_CURRENT_LEADER_SLOT_WORK_TRANSACTIONS_LANDED_OFF (266UL)

#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_OFF  (267UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_NAME "pack_bam_seq_rx_to_first_schedule_nanos"
#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_TYPE (FD_METRICS_TYPE_HISTOGRAM)
#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_DESC "Distribution of BAM scheduler-arrival to first-schedule delay for a sequence id, sampled once on the first schedule event for that sequence (nanoseconds)"
#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)
#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_MIN  (0UL)
#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_MAX  (10000000000UL)

#define FD_METRICS_GAUGE_PACK_CUS_CONSUMED_IN_BLOCK_OFF  (284UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_SCHEDULED_OFF  (285UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_REBATED_OFF  (302UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_NET_OFF  (319UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_PCT_OFF  (336UL)
...
#define FD_METRICS_COUNTER_PACK_DELETE_MISSED_OFF  (353UL)
...
#define FD_METRICS_COUNTER_PACK_DELETE_HIT_OFF  (354UL)
...
#define FD_METRICS_PACK_TOTAL (131UL)
