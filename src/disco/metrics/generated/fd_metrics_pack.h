...
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_RECORDED_OFF  (213UL)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_RECORDED_NAME "pack_bam_leader_slot_first_insert_recorded"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_RECORDED_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_RECORDED_DESC "Boolean gauge: 1 when the current pack leader slot has observed a first BAM work-item insert, 0 otherwise"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_RECORDED_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_OFF  (214UL)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_NAME "pack_bam_leader_slot_first_insert_distance_nanos"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_DESC "Absolute distance in nanoseconds between the current pack leader slot's slot_end_ns and the first BAM work-item insert observed for that slot. Exported as 0 until a first insert has been observed"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_DISTANCE_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_OFF  (215UL)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_NAME "pack_bam_leader_slot_first_insert_after_end"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_DESC "Boolean gauge: 1 when the first BAM work-item insert for the current pack leader slot arrived after slot end, 0 when it arrived before slot end or no first insert has been recorded yet"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_INSERT_AFTER_END_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RECORDED_OFF  (216UL)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RECORDED_NAME "pack_bam_leader_slot_first_schedule_recorded"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RECORDED_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RECORDED_DESC "Boolean gauge: 1 when the current pack leader slot has observed a first BAM work-item schedule event, 0 otherwise"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_RECORDED_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_OFF  (217UL)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_NAME "pack_bam_leader_slot_first_schedule_distance_nanos"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_DESC "Absolute distance in nanoseconds between the current pack leader slot's slot_end_ns and the first BAM work-item schedule observed for that slot. Exported as 0 until a first schedule has been observed"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_DISTANCE_NANOS_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_OFF  (218UL)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_NAME "pack_bam_leader_slot_first_schedule_after_end"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_DESC "Boolean gauge: 1 when the first BAM work-item schedule for the current pack leader slot occurred after slot end, 0 when it occurred before slot end or no first schedule has been recorded yet"
#define FD_METRICS_GAUGE_PACK_BAM_LEADER_SLOT_FIRST_SCHEDULE_AFTER_END_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_HISTOGRAM_PACK_BAM_SEQ_RX_TO_FIRST_SCHEDULE_NANOS_OFF  (219UL)
...
#define FD_METRICS_GAUGE_PACK_CUS_CONSUMED_IN_BLOCK_OFF  (236UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_SCHEDULED_OFF  (237UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_REBATED_OFF  (254UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_NET_OFF  (271UL)
...
#define FD_METRICS_HISTOGRAM_PACK_CUS_PCT_OFF  (288UL)
...
#define FD_METRICS_COUNTER_PACK_DELETE_MISSED_OFF  (305UL)
...
#define FD_METRICS_COUNTER_PACK_DELETE_HIT_OFF  (306UL)
