...
const fd_metrics_meta_t FD_METRICS_ALL[FD_METRICS_ALL_TOTAL] = {
    ...
    DECLARE_METRIC( TILE_PAGE_FAULT_MAJOR_COUNT, COUNTER ),
    DECLARE_METRIC( TILE_PAGE_FAULT_MINOR_COUNT, COUNTER ),
...
const ulong FD_METRICS_TILE_KIND_SIZES[FD_METRICS_TILE_KIND_CNT] = {
    ...
    FD_METRICS_SNAPWM_TOTAL,
    FD_METRICS_SNAPLH_TOTAL,
    FD_METRICS_SNAPLV_TOTAL,
