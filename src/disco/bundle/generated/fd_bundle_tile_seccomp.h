...
static const uint sock_filter_policy_fd_bundle_tile_instr_cnt = 139;

static void populate_sock_filter_policy_fd_bundle_tile( ulong out_cnt, struct sock_filter out[ static 139 ], uint logfile_fd, uint keylog_fd, uint etc_hosts_fd, uint etc_resolv_conf ) {
  FD_TEST( out_cnt >= 139 );
  struct sock_filter filter[139] = {
    ...
    /* check shutdown */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_shutdown, /* check_shutdown */ 72, 0 ),
    /* allow close */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_close, /* RET_ALLOW */ 12, 0 ),
    /* check fcntl */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_fcntl, /* check_fcntl */ 74, 0 ),
    /* check bind */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_bind, /* check_bind */ 81, 0 ),
    /* allow ppoll */
    ...
    /* check getsockopt */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_getsockopt, /* check_getsockopt */ 102, 0 ),
    /* allow getsockname */
    ...
    /* check lseek */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_lseek, /* check_lseek */ 104, 0 ),
    /* allow sched_yield */
...
//  check_socket:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, FD_SECCOMP_ARG_LO(AF_INET), /* and_7 */ 4, /* or_8 */ 0 ),
//  or_8:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, FD_SECCOMP_ARG_LO(AF_UNIX), /* and_7 */ 2, /* or_9 */ 0 ),
//  or_9:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
