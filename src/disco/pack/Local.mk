ifdef FD_HAS_DOUBLE
$(call add-hdrs,fd_pack.h fd_est_tbl.h fd_compute_budget_program.h fd_microblock.h fd_pack_rebate_sum.h fd_pack_bam_result.h)
$(call add-objs,fd_pack,fd_ballet)
$(call add-objs,fd_pack_bam_result,fd_disco)
