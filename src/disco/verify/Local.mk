...
$(call make-unit-test,test_bam_prepack_pipeline,test_bam_prepack_pipeline,fd_disco fd_ballet fd_tango fd_util)
$(call run-unit-test,test_verify)
$(call run-unit-test,test_verify_tile)
$(call run-unit-test,test_bam_prepack_pipeline)
endif
