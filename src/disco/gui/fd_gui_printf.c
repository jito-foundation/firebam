    ...
    jsonp_open_object( gui->http, "value" );
      ...
      if( FD_UNLIKELY( have_lmeta && lmeta->unbecame_leader ) ) {
        ...
        jsonp_open_object( gui->http, "limits" );
          ...
          jsonp_ulong( gui->http, "used_total_vote_cost",         scheduler_stats->limits_usage->vote_cost           );
          ...
          jsonp_ulong( gui->http, "max_total_vote_cost",         scheduler_stats->limits->max_vote_cost_per_block   );
        ...
        jsonp_open_object( gui->http, "scheduler_stats" );
          ...
          if( FD_LIKELY( scheduler_stats->pending_smallest->cus!=ULONG_MAX ) ) jsonp_ulong( gui->http, "pending_smallest_cost", scheduler_stats->pending_smallest->cus );
          else                                                                        jsonp_null( gui->http, "pending_smallest_cost" );
          if( FD_LIKELY( scheduler_stats->pending_smallest->bytes!=ULONG_MAX ) ) jsonp_ulong( gui->http, "pending_smallest_bytes", scheduler_stats->pending_smallest->bytes );
          else                                                                          jsonp_null( gui->http, "pending_smallest_bytes" );
          if( FD_LIKELY( scheduler_stats->pending_votes_smallest->cus!=ULONG_MAX ) ) jsonp_ulong( gui->http, "pending_vote_smallest_cost", scheduler_stats->pending_votes_smallest->cus );
          else                                                                              jsonp_null( gui->http, "pending_vote_smallest_cost" );
          if( FD_LIKELY( scheduler_stats->pending_votes_smallest->bytes!=ULONG_MAX ) ) jsonp_ulong( gui->http, "pending_vote_smallest_bytes", scheduler_stats->pending_votes_smallest->bytes );
